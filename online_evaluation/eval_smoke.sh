...
data_dir=$root/datasets/raw/smoke_reach_target_val
...
# 修改成 find 命令查到的真实路径
act3d_checkpoint=$root/train_logs/act3d_smoke/reach_target_5train_2val/best.pth
diff_checkpoint=$root/train_logs/trajectory_smoke/reach_target_5train_2val/best.pth
